...
//////////////################# FRONTEND ROUTE ########################/////////////////
Route::get('/',['as'=>'courses.index','uses'=>'CourseController@index']);
Route::get('/courses/{name?}',['as'=>'courses.show','uses'=>'CourseController@show']);
Route::get('/ats/{lesson_name}',['as'=>'lessons.show','uses'=>'LessonController@show']);
Route::get('/foundation/{lesson_name}',['as'=>'lessons.show','uses'=>'LessonController@show']);
