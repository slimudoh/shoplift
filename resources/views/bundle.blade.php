            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <h4 style="color:#fff">
                  ...
                  <a href="{!! url('/') !!}">HOME</a> <i class="fa fa-arrows-h"></i>  </i> {{$bundle->course->course->name}}
                </h4>
              </div>
            </div>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="about-head">
                      <h3>  {{$bundle->course->course->name}}</h3>
                      <div class="rating">
                      ...
                      <form class="form-inline" method="POST" action="{{asset('add_to_cart')}}">
                        {{csrf_field()}}
                        <input type="hidden" name="price" value="{{$bundle->course->course->price}}" />
                        <input type="hidden" name="course_id" value="{{$bundle->course->course->id}}" />
                        <input type="hidden" name="course_name" value="{{$bundle->course->course->name}}" />
                ...
                <div class="detail-sidebar">
                  ...
                  <div class="sidebar-box">
                    ...
                    <div class="sidebar-right">
                      <strong>PRICE:</strong>
                      <br>
                      &#8358;{{number_format($bundle->course->course->price)}}
                    </div>
                  </div>
