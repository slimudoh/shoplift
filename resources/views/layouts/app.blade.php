                    ...
                    <div class="col-xs-12 col-sm-6 col-md-8" style="padding: 0;">
                        <div class="menu">
                            <ul>
                                ...
                                <li id="child-2">
                                    @if(isset(Auth::User()->id)) <i class="fa fa-user" id="child-3"></i> Welcome {{ucfirst(Auth::User()->name)}} <i class="fa fa-caret-down"></i>
                                    @endif
                                ...
                                @if(!isset(Auth::User()->id))<li><a href="{{url('/signin')}}"><i class="fa fa-key"></i> SIGN IN</a></li>@endif
                                                   ...
                                                   if(isset($item['course_id'])){
                                                    ...
                                                    <div class="cart-header">
                                                        ...
                                                        <div class="item-cart">
                                                            ...
                                                            <div class="itemcart-left">
                                                                <div class="item-info">
                                                                    <div class="textleft-info">
                                                                        {{--<b>Financial Accounting</b>--}}
                                                                        {{$item[$foo.'_name']}}
                                                                    </div>
                                                                    <div class='textleft-success'>
                                                                        {{--<b>&#8358;2,000</b>--}}
                                                    ...
                                                    <button class="detail-btn" onclick="location.assign('/cart')">
                                                        CheckOut
                                                    </button>
