        ...
        <div class="detail-banner">
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-10">
                <h4 style="color:#fff">
                  <a href="{!! url('/') !!}">HOME</a> <i class="fa fa-arrows-h"></i> <a href="{!! url('courses') !!}">ATS LEVEL</a> <i class="fa fa-arrows-h"></i> {{$data->lesson->name}}
                </h4>
              </div>
            </div>
          </div>
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6">
                    <div class="about-head">
                      ...
                      <form class="form-inline" method="POST" action="{{asset('add_to_cart')}}">
                        {{csrf_field()}}
                        <input type="hidden" name="price" value="{{$data->lesson->price}}" />
                        <input type="hidden" name="lesson_id" value="{{$data->lesson->id}}" />
                        <input type="hidden" name="lesson_name" value="{{$data->lesson->name}}" />
                ...
                <div class="detail-sidebar">
                  ...
                  <div class="sidebar-box">
                    ...
                    <div class="sidebar-right">
                      <strong>PRICE:</strong>
                      <br>
                      &#8358;{{number_format($data->lesson->price)}}
                    </div>
                  </div>
